...
const ModalVariants = cva(
  cn(
    ...
    'md:data-[state=closed]:fade-out-0 md:data-[state=open]:fade-in-0 md:data-[state=closed]:zoom-out-95 md:data-[state=open]:zoom-in-95 md:data-[state=closed]:slide-out-to-top-[48%] md:data-[state=open]:slide-in-from-top-[48%] grid md:top-[50%] md:left-[50%] md:w-full md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-xl md:border md:duration-200 md:data-[state=closed]:animate-out md:data-[state=open]:animate-in'
  ),
  {
    variants: {
      side: {
